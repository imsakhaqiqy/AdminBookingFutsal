<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/harga_weekend/edit_aksi" method="POST">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <a href="<?php echo base_url('index.php/harga_weekend');?>" class="btn" type="reset">
